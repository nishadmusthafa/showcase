...
from integrator.views.ui.integration.views import Integration
import json
import mock
...
class IntegrationFormTest(UITestCase):
    ...
    def dismiss_auth_field_form(self):
        auth_field_form_cancel = self.browser.find_element_by_id("auth_field_save_cancel")
        auth_field_form_cancel.click()
    ...
    def bring_up_adding_auth_field_form(self):
        add_auth_field = self.browser.find_elements_by_css_selector('#auth_field_list .add_modal_field')[0]
    ...
    def bring_up_editing_auth_field_form(self, element_name):
        ...
        edit_button = auth_field_list_element.find_elements_by_css_selector(".edit_field")[0]
        edit_button.click()

    def delete_auth_field(self, element_name):
        auth_field_list_element = self.browser.find_element_by_id('list_' + element_name)
        delete_button = auth_field_list_element.find_elements_by_css_selector(".delete_field")[0]
        delete_button.click()
    ...
    def assert_proper_form_structure(self):
        ...
        self.assertEquals(8, number_of_form_elements)
    ...
    def test_if_auth_fields_are_added_alphabetically(self):
        ...
        auth_field_names = ['account', 'api_key']
    ...
    def test_if_add_auth_field_form_resets_after_partial_usage(self):
        self.reach_add_integration_page()
        self.bring_up_adding_auth_field_form()
        self.populate_and_submit_add_auth_field_form('without_mandatory_auth_field.json')
        self.dismiss_auth_field_form()
        self.bring_up_adding_auth_field_form()
    ...
    def test_delete_auth_field_functionality(self):
        ...
        auth_field_names = ['account', 'api_key', 'email']
        self.verify_auth_field_list_order(auth_field_names)
    ...
    def test_submission_of_duplicate_name_in_auth_field_form(self):
        ...
        self.assert_form_error_for_field('element', 'element name account already exists')
    ...
    def test_successful_addition_of_integration(self):
        self.reach_add_integration_page()
        self.json_to_integration_form(self.test_data_directory + 'success_case_integration_form.json')
